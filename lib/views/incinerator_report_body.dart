...
class IncineratorReportBody extends StatefulWidget {
  const IncineratorReportBody({super.key});

  @override
  State<IncineratorReportBody> createState() => _IncineratorReportBodyState();
}

class _IncineratorReportBodyState extends State<IncineratorReportBody> {
     int index = 0;
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              'Day: ',
                              style:
                                  TextStyle(color: Colors.black87, fontSize: wid / 25),
                            ),
                            Text(
                              'Sunday',
                              style: TextStyle(
